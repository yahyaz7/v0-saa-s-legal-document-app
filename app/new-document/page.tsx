...
import { FileDown, Save, Check, ChevronDown, Plus, Sparkles, BookOpen } from "lucide-react";
...
function DocumentBuilderContent() {
  ...
  // Offences extracted from the form — pulled from any repeater with an offence sub-field
